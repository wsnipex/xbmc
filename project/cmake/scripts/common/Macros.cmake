...
# 
function (build_external_project target prefix url patchcmd args) #FOLLOWING ARGUMENTS are the CMAKE_ARGS of ExternalProject_Add
    ...
    execute_process(COMMAND ${CMAKE_COMMAND} --build . -- -j4 WORKING_DIRECTORY ${trigger_build_dir}/build)
